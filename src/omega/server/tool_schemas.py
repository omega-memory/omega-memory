    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "entity_id": {"type": "string", "description": "Caller entity scope used to authorize action='supersede'. The outdated memory and replacement must both belong to this entity."},
                "project": {"type": "string", "description": "Caller project scope used to authorize action='supersede'. The outdated memory and replacement must both belong to this project."},
                "caller_session_id": {"type": "string", "description": "Caller session scope used to authorize action='supersede'. The outdated memory and replacement must both belong to this session."},
            ...
            "properties": {
                ...
                "category": {
                    ...
                    "enum": ["memory", "query", "session", "maintenance", "intelligence",
                             ...
                             "knowledge", "entity", "audit", "dreaming", "federation",
                             "ingest", "stores", "typed", "all"],
